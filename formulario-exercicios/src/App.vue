	...
	<div id="app">
		...
		<div class="conteudo">
			<form class="painel" v-if="!enviado">
				...
				<!-- o V-model possui 3 modificadores de acesso, o lazy, trim e number -->
				<!-- o lazy s faz o bind do valor apos o foco sair da tag -->
				<!-- o trim retira os espaços em branco -->
				<!-- o number transforma em numero se oque estiver no campo for numero(normalmente o bind transforma em string) -->
				<Rotulo nome="E-mail">
					<input type="text" v-model.lazy.trim="usuario.emal">
				</Rotulo>
				<Rotulo nome="Senha">
				...
				<Rotulo nome="Mensagem">
					<textarea v-model="mensagem" name="mensagem" cols="30" rows="5"></textarea>
				</Rotulo>
				...
				<Rotulo nome="Prioridade">
					<select v-model="prioridade">
						<option v-for="p in prioridades" :selected="p.codigo === 1" :value="p.codigo" :key="p.codigo">{{p.nome}}</option>
					</select>
				</Rotulo>
